...
def train_model(train_data, dev_data, model, lr=0.05,
                momentum=0.9, nesterov=False, n_epochs=300):
...
def run_epoch(data, model, optimizer):
    ...
    avg_accuracy = np.mean(batch_accuracies_first),\
                   np.mean(batch_accuracies_second)
