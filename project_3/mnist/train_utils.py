...
def batchify_data(x_data, y_data, batch_size):
    ...
    for i in range(0, N, batch_size):
        batches.append({'x': torch.tensor(x_data[i:i+batch_size],
...
# Training Procedure
def train_model(train_data, dev_data, model, lr=0.01,
                momentum=0.9, nesterov=False, n_epochs=30):
    ...
    for epoch in range(1, 11):
        ...
        print('Val loss:   {:.6f} | Val accuracy:   {:.6f}'
